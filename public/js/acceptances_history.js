...
document.getElementById('app').innerHTML = layout('驗收歷史', `<div class="list-panel"><div class="toolbar"><input id="search" placeholder="輸入客戶 / 聯絡人查詢"></div><div id="list"></div></div>`);
let rows=[]; async function load(){ rows=await API.listAcceptances(); render(); }
