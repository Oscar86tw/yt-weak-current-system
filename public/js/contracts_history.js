...
document.getElementById('app').innerHTML = layout('合約歷史', `
<div class="list-panel">
  <div class="toolbar"><input id="search" placeholder="輸入客戶 / 合約名稱查詢"></div>
  <div id="list"></div>
</div>`);
let rows = [];
async function load(){ rows = await API.listContracts(); render(); }
